	...
	descriptions = {
		...
		Blind = {
			...
			bl_charcuterie_bighouse = {
				...
				text = {
					...
					"discarding a card also discards",
					"all cards of same suit and rank held in hand",
				},
			},
			bl_charcuterie_biggerhouse = {
				...
				text = {
					"First hand is drawn face down",
					"discarding a card discards",
					"every card of the same suit",
					"in your full deck",
				},
			},
			bl_charcuterie_bigwheel = {
				...
				text = {
					...
					"face down cards have a #3# in #4# chance of",
					"changing suit when played",
				},
			},
			bl_charcuterie_biggerwheel = {
				...
				text = {
					"#1# in #2# cards drawn face down",
					"face down cards have a #3# in #4# chance of",
					"changing suit and rank when played",
				},
			},
			...
			bl_charcuterie_bigwater = {
				...
				text = {
					...
					"if you've discarded over 5 times this ante",
		...
		Edition = {
			...
			e_charcuterie_melty = {
				...
				text = {
					...
					"{C:red}#3#%{}chance to destroy itself instead.",
				},
			},
		},
		Enhanced = {
		...
		Joker = {
			...
			j_charcuterie_crazyeight = {
				name = "Crazy 8",
				text = {
					"If there are at least {C:attention}#1#{} Eights",
					"in your {C:attention}Full Deck{}",
					"{X:mult,C:white}X#2#{} Mult for each",
					"Eight in your {C:attention}Full Deck",
					"{C:inactive,S:0.5}(currently {}{X:mult,C:white,S:0.5}X#3#{}{C:inactive,S:0.5})",
				},
			},
			...
			j_charcuterie_caption = {
				...
				text = {
					...
					"Joker slot {C:attention}above{} 5.",
					"{S:0.7,C:inactive}(currently {}{S:0.7,C:white,X:mult} X#2#{}{S:0.7,C:inactive}.)",
				},
			},
			j_charcuterie_ambrosia = {
				name = "Ambrosia",
				text = {
					"Removes {C:red}Cursed{} from scored cards",
					"for {C:attention}#1#{} hands",
					"{C:inactive,S:0.7}( #2# remaining){}",
				},
			},
			j_charcuterie_potion = {
				name = "Mysterious Potion",
				text = {
					"When sold, {C:green}#1#%{} chance to duplicate a random {C:attention}Joker{},",
					"{C:red}#2#%{} chance to do {C:attention}nothing{}",
					"{C:inactive,S:0.7}( Removes {}{C:dark_edition,S:0.7}Negative{}{C:inactive,S:0.7} from copy.){}",
				},
			},
			j_charcuterie_twotime = {
				name = "Two Time",
				text = {
					"When {C:attention}Blind{} is selected, {C:red}destroy{} Joker to the {C:attention}left{}",
					"and gain {X:black,C:white}x#1#{} Oblation.",
					"If this card has over {X:black,C:white}x#2#{} Oblation, prevents {C:attention}Death{}.",
					"When death is prevented, convert all {X:black,C:white}Oblation{} into {X:mult,C:white}XMult{} and",
					"prevent further {X:black,C:white}Oblation{} gain.",
					"{C:inactive,S:0.7}(Current Oblation: {X:black,C:white}x#3#{C:inactive,S:0.7}.)",
					"{C:inactive,S:0.7}(Current Mult: {X:red,C:white}x#4#{C:inactive,S:0.7}.)",
				},
			},
			j_charcuterie_ripped = {
				...
				text = {
					...
					"{C:inactive,S:0.7}(Currently {X:mult,C:white,S:0.7}X#2#{C:inactive,S:0.7}.)",
				},
			},
			j_charcuterie_007n7 = {
				name = "007n7",
				text = {
					"Create a {C:attention}Perishable{} copy of a random Joker",
					"every {C:attention}#1#{} rounds",
					"{C:inactive,S:0.7}({C:attention,S:0.7}#2#{C:inactive,S:0.7} remaining.)",
				},
			},
			j_charcuterie_c00lkid = {
				...
				text = {
					...
					"{C:inactive,S:0.7}(Currently {X:chips,C:white,S:0.7}X#2#{C:inactive,S:0.7}.)",
				},
			},
			...
			j_charcuterie_debt_collector = {
				name = "Debt Collector",
				text = {
					"Gives {C:attention}50%{} of every {C:attention}Joker{}'s sell value combined",
					"at the {C:attention} end of the round.",
					"{C:inactive,S:0.7}(Currently {C:attention,S:0.7}$#1#{C:inactive,S:0.7}.)",
				},
			},
			j_charcuterie_bunny = {
				name = "Bunny",
			...
			j_charcuterie_mutated = {
				name = "Mutated Joker",
				text = {
					"played {C:charcuterie_unstable}Unstable Cards{}",
					"have a {C:green}#1#%{} chance of giving {C:attention}$2{}when played",
					"but now has a {C:red}#2#%{} chance of destroying itself.",
				},
			},
			j_charcuterie_cursed_die = {
				...
				text = {
					...
					"but locks {C:red}Risk{} to {C:attention}Max{}",
				},
			},
			j_charcuterie_chance = {
				...
				text = {
					...
					"{C:green}#1# in #4#{} chance to {C:red}remove{} {C:chips}#5#{} Chips",
					"{C:green}#1# in #6#{} chance to give {X:mult,C:white}X#6#{} Mult",
					"and {C:attention}$#6#{}",
				},
			},
			...
			j_charcuterie_paranoia = {
				...
				text = {
					...
					"creating a {C:dark_edition}Negative {C:attention}Spectral{} Card when",
					"booster pack opened",
				},
			},
			j_charcuterie_prank = {
			...
			j_charcuterie_redqueen = {
				name = "Red Queen",
				text = {
					"{C:white,X:mult}X#1#{} Mult on last scored card",
					"{C:attention}increases{} by {C:white,X:mult}X#2#{} Mult for",
					"every card scored prior",
			...
			j_charcuterie_doubleagent = {
				...
				text = {
					...
					"the Joker to the {C:attention}left{} or {C:attention}right{}",
					"{C:red}debuffs{} the other",
				},
			},
			j_charcuterie_usm = {
				...
				text = {
					...
					"every {C:attention}mod{} currently installed",
					"{C:inactive,S:0.7}(Currently {X:mult,C:white,S:0.7}X#2#{C:inactive,S:0.7}.)",
				},
			},
			j_charcuterie_overclock = {
				...
				text = {
					...
					"Jokers that are {C:attention}not{} itself",
					"{C:green}#1# in #2#{} chance to",
					"{C:red}destroy{} affected Joker",
			...
			j_charcuterie_snake_eyes = {
				...
				text = {
					...
					"but {C:attention}halves{} {C:red}Risk{} gain",
				},
			},
			...
			j_charcuterie_rusty_razor = {
				...
				text = {
					"when entering blind,",
					"{C:red}destroy{} the jokers to",
					"the {C:attention}left and right{} of this card",
					"and add {C:attention}triple{} their sell value to {C:mult}Mult{}",
					"{C:green}#2# in #3#{} chance of {C:red}destroying{} itself instead",
					"{C:inactive,S:0.7}(Currently {C:mult,S:0.7}+#4#{C:inactive,S:0.7}.)",
				},
			},
			j_charcuterie_magic_bullet = {
				...
				text = {
					...
					"loses {X:mult,C:white}X#2#{} Mult when {C:tarot}Tarot{} card used",
					"loses {X:mult,C:white}X#3#{} Mult when {C:spectral}Spectral{} card used",
					"{C:inactive,S:0.7}(Currently {X:mult,C:white,S:0.7}X#4#{C:inactive,S:0.7}.)",
				},
			},
			...
			j_charcuterie_dubious_merchant = {
				...
				text = {
					"Gives anywhere from ",
					"{C:attention}#1#{} to {C:attention}#2#{}",
					"card slots in shop",
					"{C:inactive}Resets before shop{}",
					"{C:inactive,S:0.7}(Currently {C:attention,S:0.7}#3#{C:inactive,S:0.7}.)",
				},
			},
			j_charcuterie_tidal_wave = {
				name = "Tidal Wave",
				text = {
					"If number of scored cards is {C:attention}odd{},",
					"gain {X:mult,C:white}X#1#{} Mult relative to the",
					"{C:attention}combined{} ranks of scored cards",
					"{C:inactive,S:0.7}(Currently {X:mult,C:white,S:0.7}X#2#{C:inactive,S:0.7}.)",
				},
			},
			...
			j_charcuterie_magic_wand = {
				name = "Magic Wand",
				text = {
					"When blind {C:attention}selected{}",
			...
			j_charcuterie_sidekick = {
				...
				text = {
					...
					"{C:inactive}(Currently {C:chips}+#3#{}{C:inactive},{X:chips,C:white} X#2#{}{C:inactive}Chips){}",
				},
			},
			j_charcuterie_rigged_ballot = {
				...
				text = {
					...
					"scored cards {C:attention}#1# to #2#{}",
					"additional times",
				},
			...
			j_charcuterie_cannonball = {
				...
				text = {
					...
					"a card that wouldn't normally score does",
				},
			...
			j_charcuterie_split_atom = {
				...
				text = {
					...
					"played hand contains {C:attention}3{} or fewer cards",
					"{C:green}#2# in #3#{} chance to {C:red}destroy{} played cards otherwise",
				},
			...
			j_charcuterie_bank_robbery = {
				...
				unlock = { "Overclock  {C:attention}Burglar{}" },
			},
			j_charcuterie_whiteboard = {
				name = "Whiteboard",
				text = {
					"{C:white,X:mult}X#1#{} Mult if hand contains only",
					"{C:hearts}#2#{} and {C:diamonds}#3#{}",
					"or {C:spades}#4#{} and {C:clubs}#5#{}",
				},
			},
			j_charcuterie_stargazer = {
				name = "Stargazer",
				text = {
					"when entering blind,",
					"Creates a {C:dark_edition}Negative{} {C:planet}Planet Card",
					"of your {C:attention}most played{} hand ",
					"{C:inactive,S:0.5}All planet cards and celestial packs in shop are free{}",
				},
				unlock = { "Overclock {C:attention}Astronomer" },
			},
			j_charcuterie_ring_of_fire = {
				name = "Ring of Fire",
				text = {
		...
		Other = {
			...
			char_txt_immobile = {
				...
				text = {
					...
					"{C:attention}any{} changes to its values",
					"{C:inactive,S:0.5}(Charcuterie Only){}",
				},
			},
			char_txt_oc = {
				name = "Overclocked",
			...
			char_txt_ochint_hinder = {
				name = "Overclockable",
				text = {
					"To overclock this Joker",
					"you must do something",
					"that would otherwise hinder",
					"the card's function...",
				},
			},
      ...
      char_txt_ochint_obviousmineral = {
        name = 'Overclockable',
        text = {'To overclock this Joker',"get {C:attention}40{} of this Joker's corresponding suit"}
      },
			char_txt_ochint_rtb = {
				name = "Overclockable",
				text = { "To overclock this Joker", "you must {C:attention}crash the bus.{}" },
			},
      char_txt_ochint_obviousrtb = {
        name = 'Overclockable',
        text = {'To overclock this Joker',"Reset scaling {C:attention}at or above{}","{C:mult}+25{} Mult"}
      },
			char_txt_ochint_golden = {
				name = "Overclockable",
				text = { "To overclock this Joker", "you must achieve a score {C:attention}insurmountable" },
			},
      char_txt_ochint_obviousgolden = {
        name = 'Overclockable',
        text = {'To overclock this Joker','score at least {C:attention}three{} times the blind requirement'}
      },
      char_txt_whoops = {
        name = 'Whoops!',
        text = {'For whatever reason,','this info_queue entry {C:attention}Failed to load{}','Please contact me!'}
			...
			charcuterie_lime_seal = {
				...
				text = {
					"{C:green}#1# in #2#{} chance to",
					"create an {C:charcuterie_unstable}Unstable{} card when scored",
				},
			},
		...
		ritual = {
			...
			c_charcuterie_summon = {
				name = "Summon",
				text = {
					"{C:red}Destroy{} 2 random {C:attention}Jokers{}",
					"{C:green}#1#%{} to create a {C:purple}Legendary{} Joker.",
				},
			},
			c_charcuterie_alchemy = {
				name = "Alchemy",
				text = {
					"{C:green}#1#%{} chance to make entire hand {C:attention}Gold{}",
