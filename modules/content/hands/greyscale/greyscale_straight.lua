SMODS.PokerHand {
  ...
  example = {
    ...
    { 'H_6', true, edition = "e_charcuterie_bleached" },  -- 9 of Spades, scores
    { 'D_5', true,  edition = "e_charcuterie_bleached" },             -- Negative Lucky 9 of Diamonds, scores
    { 'H_4', true,  edition = "e_charcuterie_bleached"},             -- 6 of Hearts, does not score
