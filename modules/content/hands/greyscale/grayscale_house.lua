SMODS.PokerHand {
	...
	example = {
		...
		{ 'H_7', true, edition = "e_astropulvis_bleached" },  -- 9 of Spades, scores
		{ 'D_7', true,  edition = "e_astropulvis_bleached" },             -- Negative Lucky 9 of Diamonds, scores
		{ 'H_3', true,  edition = "e_astropulvis_bleached"},             -- 6 of Hearts, does not score
